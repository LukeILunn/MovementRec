            ...
            sendTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onFailure(@NonNull Exception e) {
                    mainHandler.post(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(context, "Could not send start to watch", Toast.LENGTH_LONG).show();
                        }
                    });
                    iMessageHandler.messageFailed("Could not send start to watch");
                }
            });
        } else {
            //Toast.makeText(context, "Could not find watch", Toast.LENGTH_LONG);
            iMessageHandler.messageFailed("No compatible devices connected");
